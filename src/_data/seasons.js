...
export default [
  ...
  },
  {
    ...
    metaDescription: "Talk to your accountant for your situation, but for most U.S. and Canadian small businesses, monthly website fees are an ordinary, deductible expense.",
    shareCard: "/assets/img/og-default.jpg",
  ...
  },
  {
    ...
    metaDescription: "Different trades have different quiet months. Whichever yours is, that is the window for a rebuild you can think clearly about and finish on time.",
    shareCard: "/assets/img/og-default.jpg",
  ...
  },
  {
    ...
    metaDescription: "I am one operator. The person who answers the phone is the same person who designs your homepage and writes the deployment script. Different from an agency.",
    shareCard: "/assets/img/og-default.jpg",
  ...
  },
  {
    ...
    metaDescription: "December is when a lot of service businesses still have operating budget on the books. A website is one of the few line items that earns leads for ten years.",
    shareCard: "/assets/img/og-default.jpg",
